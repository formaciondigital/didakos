...
// Access restrictions
api_protect_gestor_script(true);
...
<h4><img src="../img/members.gif" border="0" style="vertical-align: middle;" alt="" /> <?php echo ucfirst(get_lang('Users')); ?></h4>
	<ul><li style="list-style-type:none"><form method="get" action="fd_lista_alumnos.php">

	<input type="text" name="keyword" value="<?php echo $keyword_url; ?>"/>
	<input type="submit" value="<?php echo get_lang('Search'); ?>"/>
	</form></li>
	
<li><a href="fd_lista_alumnos.php"><?php echo get_lang('ListadoDeAlumnos'); ?></a></li>
<li><a href="fd_lista_profesores.php"><?php echo get_lang('ListadoDeProfesores'); ?></a></li>
<li><a href="fd_lista_inspectores.php"><?php echo get_lang('ListadoDeInspectores'); ?></a></li>
<li><a href="fd_comprueba_dni.php?tipo_usuario=alumno"><?php echo get_lang('AnnadirAlumnos'); ?></a></li>
<li><a href="fd_comprueba_dni.php?tipo_usuario=profesor"><?php echo get_lang('AnnadirProfesores'); ?></a></li>
<li><a href="fd_user_import.php"><?php echo get_lang('ImportacionMasivaDeUsuarios'); ?></a></li>
...
<h4><img src="../img/course.gif" border="0" style="vertical-align: middle;" alt="" /> <?php echo ucfirst(get_lang('Courses')); ?></h4>
	<ul><li style="list-style-type:none"><form method="get" action="fd_lista_cursos.php">

	<input type="text" name="keyword" value="<?php echo $keyword_url; ?>"/>
	<input type="submit" value="<?php echo get_lang('Search'); ?>"/>

	</form>
<li><a href="fd_lista_cursos.php?search=advanced"><?php echo ucfirst(get_lang('AdvancedSearch')); ?></a></li>
<li><a href="fd_course_add.php"><?php  echo get_lang('AddCourse') ?></a></li>
<li><a href="fd_lista_cursos.php"><?php echo get_lang('CourseList') ?></a></li>
...
*/?>
<li><a href="fd_subscribe_user2course.php"><?php echo get_lang('AddUsersToACourse'). ' ('.get_lang('Matricular').')'; ?></a></li>
<?php /* 'eliminado
<li><a href="course_user_import.php"><?php echo get_lang('AddUsersToACourse').' CSV'; ?></a></li>
*/?>
<li><a href="fd_desmatricular_0.php"><?php echo get_lang('EliminarUsuariosDeCursos'). ' ('.get_lang('Desmatricular').')'; ?></a></li>
<li><a href="fd_asignar_profesores_0.php"><?php echo get_lang('AsignarProfesoresACursos'); ?></a></li>
<li><a href="fd_finalizar_cursos.php"><?php echo get_lang('FinalizarCursos'). ' ('.get_lang('CerrarAcceso').')'; ?></a></li>
</ul>
</div>
<div class="admin_section">
    <h4>
  <img src="../img/diploma.gif" border="0" style="vertical-align: middle;" alt="" />
  <?php echo ucfirst(get_lang('diplomas')); ?>
 </h4>
    <ul>
    <li><a href="diplomas/config.php"><?php echo get_lang('config'); ?> </a></li>
    <li><a href="diplomas/design_add.php"><?php echo get_lang('design_add'); ?></a> | 
    <a href="diplomas/design_selection.php?action=edit"><?php echo get_lang('design_edit'); ?></a> | 
    <a href="diplomas/design_selection.php?action=delete"><?php echo get_lang('design_delete'); ?></a></li>
    <li><a href="diplomas/courses.php"><?php echo get_lang('courses'); ?> </a></li>
    <li><a href="diplomas/track_diplomas_0.php"><?php echo get_lang('diplomastrack'); ?> </a></li>
    <ul>
</div>        
...
*/?>
<div class="admin_section">
 <h4><img src="../img/settings.gif" border="0" style="vertical-align: middle;" alt="" /> <?php echo get_lang("Informes"); ?></h4>
 <ul>
  <li><a href="fd_lista_cursos_seguimiento.php"><?php echo get_lang("SeguimientoPorCurso"); ?></a></li>
   <li><?php echo get_lang("CartasDeBienvenida"); ?>: <br><a href="fd_bienvenida_add.php"><?php echo get_lang("Crear"); ?></a> | <a href="fd_bienvenida_seleccion.php?accion=editar"><?php echo get_lang("Editar"); ?></a> | <a href="fd_bienvenida_seleccion.php?accion=eliminar"><?php echo get_lang("Eliminar"); ?></a><br><a href="fd_bienvenida_seleccion.php?accion=curso"><?php echo get_lang("EnviarACurso"); ?></a> | <a href="fd_bienvenida_seleccion.php?accion=alumno"><?php echo get_lang("EnviarAAlumno"); ?></a><!--| <a hraf="fd_bienvenida_seleccion.php?accion=clase"><?php echo get_lang("Enviar a clase"); ?>/a>--></li>

<!--<li><a href="fd_seg_diplomas_0.php">Seguimiento de descarga de diplomas</a></li>-->
 </ul>
</div>
...
<div class="admin_section">
 <h4>
  <img src="../img/settings.gif" border="0" style="vertical-align: middle;" alt="" />
  <?php echo get_lang("redessociales"); ?>
 </h4>
 <ul>
  <li><a href="fd_redes_sociales.php"><?php echo get_lang("redessocialesconfig"); ?></a></li>
 </ul>
</div>
<?php
endif;
