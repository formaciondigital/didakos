...
Página incial: fd_desmatricular_0.php (FD versión 0.3)
Página actual: fd_seg_diplomas_0.php
Descripción: Página que muestra un listado de cursos y un enlace para cada curso
que lleva a un listado de alumnos con las descargas realizadas de diplomas (fd_seg_diplomas_1.php)
...
function get_course_data($from, $number_of_items, $column, $direction)
{
	...
	{
		$enlace = '<a target="_self" href="fd_seg_diplomas_1.php?code='. $course[1] . '"><img src="../img/group_view.gif"></a>';
		...
		$course_rem = array($course[1] . ' / ' . $course[2],$course[3],$course[4],$course[5],$course[6],$course[8],$enlace);
		$courses[] = $course_rem;
	}
	return $courses;
}
...
else
{
	...
	$form->addElement('static','search_advanced_link',null,'<a href="fd_seg_diplomas_0.php?search=advanced">'.get_lang('AdvancedSearch').'</a>');
	$form->display();
	...
	$table->set_header(5, get_lang('Teacher'));
		$table->set_header(6, 'Ver alumnos');
