...
Página actual: fd_lista_cursos_seguimento.php
Descripción: Página que muestra un listado de cursos y un enlace para cada curso
que lleva a un listado de seguimiento de alumnos
...
{
	$interbreadcrumb[] = array ("url" => 'index.php', "name" => get_lang('PlatformAdmin'));
	$tool_name = get_lang("SeguimientoPorCurso");
	Display :: display_header($tool_name);
	//api_display_tool_title($tool_name);
	...
	$form->addElement('static','search_advanced_link',null,'<a href="fd_lista_cursos_seguimiento.php?search=advanced">'.get_lang('AdvancedSearch').'</a>');
	$form->display();
	...
	$table->set_header(9, get_lang('VerSeguimiento'), false,'width="60px"');	
