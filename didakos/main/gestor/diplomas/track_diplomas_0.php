...
function get_course_data($from, $number_of_items, $column, $direction)
{
	...
	{
		$enlace = '<a target="_self" href="track_diplomas_1.php?code='. $course[1] . '"><img src="../../img/group_view.gif"></a>';
...
if (isset ($_GET['search']) && $_GET['search'] == 'advanced')
{
	...
	$interbreadcrumb[] = array ("url" => 'track_diplomas_0.php', "name" => get_lang('CourseList'));
...
else
{
	...
	$form->addElement('static','search_advanced_link',null,'<a href="track_diplomas_0.php?search=advanced">'.get_lang('AdvancedSearch').'</a>');
	$form->display();
	...
	$table->set_header(6, get_lang("seeusers"));
	$table->display();
}
/*
==============================================================================
