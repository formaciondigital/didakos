...
Página actual: fd_course_edit.php
Descripción: Página de modificación de cursos
...
$interbreadcrumb[] = array ("url" => "fd_lista_cursos.php", "name" => get_lang('AdminCourses'));
...
$form->add_textfield('visual_code', get_lang('CourseCode'),false, array ('readonly' => 'true' ));
...
/*
$group=array();
$group[] = FormValidator::createElement('select', 'platform_teachers', '', $teachers, 'id="platform_teachers" multiple=multiple size="10" style="width: 150px;"');
$group[] = FormValidator::createElement('select', 'course_teachers', '', $course_teachers, 'id="course_teachers" multiple=multiple size="10" style="width: 150px;"');

$element_template = <<<EOT
	<div class="row" visibility="hidden">
		<div class="label">
