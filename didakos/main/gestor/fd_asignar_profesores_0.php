...
Página actual: fd_asignar_profesores_0.php
Descripción: Página que muestra un listado de cursos y un enlace para cada curso
que lleva a la pagina de editar para asignarle un profesor (fd_asifnar_profesores_1.php)
...
function get_course_data($from, $number_of_items, $column, $direction)
{
	...
	{
		$enlace = '<a target="_self" href="fd_asignar_profesores_1.php?course_code='. $course[1] . '"><img src="../img/edit.gif"></a>';
...
else
{
	...
	$form->addElement('static','search_advanced_link',null,'<a href="fd_asignar_profesores_0.php?search=advanced">'.get_lang('AdvancedSearch').'</a>');
	$form->display();
	...
	$table->set_header(5, get_lang('Teacher'));
		$table->set_header(6, get_lang('Asignar'));
