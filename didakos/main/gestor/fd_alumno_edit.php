...
Página actual: fd_alumno_edit.php
Descripción: Página de modificación de alumnos
...
{
	header('Location: fd_lista_alumnos.php');
	exit;
}
...
$drh_list = UserManager :: get_fd_lista_modificar(array('status'=>DRH),array('lastname','firstname'));
...
if( $form->validate())
{
	...
	header('Location: fd_lista_alumnos.php?tipo=alumno&action=show_message&message='.urlencode(get_lang('UserUpdated')));
	exit();
}
