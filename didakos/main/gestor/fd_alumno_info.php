...
Página incial: user_information.php (1.8.5)
Página actual: fd_alumno_info.php
Descripción: Página que muestra un listado de los cursos en los que esta matriculado
un alumno. Eliminamos opciones de control sobre los cursos y posibilidad de desmatricular
desde aquí.

25/06/2008 - mostramos mas datos del alumno
...
//fdupdate - enlazamos la libreria para el amnejo de los usuarios
...
//fdupdate - cambiamos el procedimiento de obtencion de los datos para obtener tambien los campos extra
$user2 = UserManagerFD::get_user_info_by_id($_GET['user_id'],true);
...
//fdupdate - mostramos el valor de los campos extra

echo '<p><b>Edad:</b> '.$user2['extra']['edad'] .'</p>';
echo '<p><b>Sexo:</b> '.$user2['extra']['sexo'] .'</p>';
echo '<p><b>Direcci&oacute;n:</b> '.$user2['extra']['direccion'] .'</p>';
echo '<p><b>Localidad:</b> '.$user2['extra']['localidad'] .'</p>';
echo '<p><b>Provincia:</b> '.$user2['extra']['provincia'] .'</p>';
echo '<p><b>Categoria:</b> '.$user2['extra']['categoria'] .'</p>';
echo '<p><b>Formaci&oacute;n:</b> '.$user2['extra']['formacion'] .'</p>';
echo '<p><b>Contrato:</b> '.$user2['extra']['contrato'] .'</p><br><br>';
...
if(count($sessions)>0){
	...
	foreach($sessions as $enreg){
		...
		foreach ($personal_course_list as $my_course){
			...
			$tools = '<a href="fd_curso_info.php?code='.$my_course['k'].'"><img src="../img/synthese_view.gif" border="0" style="vertical-align: middle" /></a>';
...
if (mysql_num_rows($res) > 0)
{
	...
	while ($course = mysql_fetch_object($res))
	{
		...
		$tools = '<a href="fd_curso_info.php?code='.$course->code.'"><img src="../img/synthese_view.gif" border="0" style="vertical-align: middle" /></a>';
