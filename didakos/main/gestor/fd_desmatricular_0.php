...
Página actual: fd_desmatricular_0.php
Descripción: Página que muestra un listado de cursos y un enlace para cada curso
que lleva a un listado de alumnos matriculados en el curso (fd_desmatricular_1.php)
...
function get_course_data($from, $number_of_items, $column, $direction)
{
	...
	{
		$enlace = '<a target="_self" href="fd_desmatricular_1.php?code='. $course[1] . '"><img src="../img/group_view.gif"></a>';
...
{
	$interbreadcrumb[] = array ("url" => 'index.php', "name" => get_lang('PlatformAdmin'));
	$tool_name = get_lang('DesmatricularAlumnos');
	Display :: display_header($tool_name);
	//api_display_tool_title($tool_name);
	...
	$form->addElement('static','search_advanced_link',null,'<a href="fd_desmatricular_0.php?search=advanced">'.get_lang('AdvancedSearch').'</a>');
	$form->display();
	...
	$table->set_header(5, get_lang('Teacher'));
		$table->set_header(6, get_lang('VerAlumnos'));
