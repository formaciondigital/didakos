...
$interbreadcrumb[] = array ("url" => 'fd_lista_cursos.php', "name" => get_lang('Courses'));
...
if (mysql_num_rows($res) > 0)
{
	...
	while ($obj = mysql_fetch_object($res))
	{
		...
		$user[] = '<a href="fd_alumno_info.php?user_id='.$obj->user_id.'"><img src="../img/synthese_view.gif" border="0" /></a>';
		$users[] = $user;
	}
