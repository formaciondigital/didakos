...
Página actual: fd_lista_cursos.php
Descripción: Página que muestra un listado de los cursos quitando opciones de
eliminar cursos.
...
function modify_filter($code)
{
	global $charset;
	return
		'<a href="fd_curso_info.php?code='.$code.'"><img src="../img/synthese_view.gif" border="0" style="vertical-align: middle" title="'.get_lang('Info').'" alt="'.get_lang('Info').'"/></a>&nbsp;'.
		...
		'<a href="../tracking/courseLog_FD.php?cidReq='.$code.'&studentlist=true"><img src="../img/statistics.gif" border="0" style="vertical-align: middle" title="'.get_lang('Tracking').'" alt="'.get_lang('Tracking').'"/></a>&nbsp;'.	
'<a href="fd_course_edit.php?course_code='.$code.'"><img src="../img/edit.gif" border="0" style="vertical-align: middle" title="'.get_lang('Edit').'" alt="'.get_lang('Edit').'"/></a>&nbsp;';
}
/**
...
if (isset ($_GET['search']) && $_GET['search'] == 'advanced')
{
	...
	$interbreadcrumb[] = array ("url" => 'fd_lista_cursos.php', "name" => get_lang('CourseList'));
...
else
{
	...
	$form->addElement('static','search_advanced_link',null,'<a href="fd_lista_cursos.php?search=advanced">'.get_lang('AdvancedSearch').'</a>');
	$form->display();
	...
	$table->set_header(6, get_lang('IsVirtualCourse'));
	$table->set_header(7, get_lang('Teacher'));
	$table->set_header(8, get_lang('Options'));
