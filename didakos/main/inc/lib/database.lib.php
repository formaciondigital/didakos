...
define('TABLE_MAIN_COURSE_USER_FD', 'course_rel_user_fd');
...
define('TABLE_MAIN_MATRICULACIONES', 'course_rel_user_fd');
define('TABLE_DMAIL', 'dmail_main');
define('TABLE_DMAIL_CARPETAS', 'dmail_carpetas');
define('TABLE_DMAIL_ADJUNTOS', 'dmail_adjuntos');
define('TABLE_MAIN_BIENVENIDA', 'fd_bienvenida');
define('TABLE_DIPLOMAS_CONFIG', 'diplomas_config');
define('TABLE_DIPLOMAS_DESIGN', 'diplomas_design');
define('TABLE_DIPLOMAS_COURSES', 'diplomas_courses');
define('TABLE_DIPLOMAS_TRACK', 'diplomas_track');
define('TABLE_REDES_SOCIALES', 'redes_sociales');
define('TABLE_MAIN_VLAB_PRACTICAS', 'vlab_practicas');
define('TABLE_MAIN_VLAB_PETICIONES', 'vlab_control_peticiones');
...
define('TABLE_FCHAT', 'fchat');
define('TABLE_COURSE_DESCRIPTION', 'course_description');
define('TABLE_DOCUMENT', 'document');
// Para los contenidos multimedia
define('TABLE_MULTIMEDIA', 'multimedia');
define('TABLE_MULTIMEDIA_SOURCES', 'multimedia_sources');
define('TABLE_MULTIMEDIA_POST', 'multimedia_post');
//Glosario
define('TABLE_GLOSARIO', 'glosario');
...
//Redes sociales
define('TABLE_SOCIAL_CONFIG', 'social_config');
define('TABLE_PARAMETROS_TWITTER', 'parametros_twitter');
define('TABLE_PARAMETROS_FACEBOOK', 'parametros_facebook');
...
define('TABLE_QUIZ_TEST_EXAM', 'quiz_exam');
