...
class DocumentManager
{
	...
	*/
	...
	/**
	 * Gets the id of a multimedia with a given path
	 *
	 * @param array $_course
	 * @param string $path
	 * @return int id of document / false if no doc found
	 */
	function get_multimedia_id($_course, $path)
	{
		$TABLE_MULTIMEDIA = Database :: get_course_table(TABLE_MULTIMEDIA, $_course['dbName']);

		$sql = "SELECT id FROM $TABLE_MULTIMEDIA WHERE target LIKE BINARY '$path'";
