...
*/
	...
	//23-01-2012 . Modificada la funcion que graba la nota del ejercicio en track_e_exercise para solucionar el bug
	//que provocaba que al grabase un examen y sus respuestas,tras ser borrado un examen,los exe_id no se correspondieran
	//se fuerza a usar el exe_id enviado por parametro en lugar del auntoincrement
	
function event_exercice($exe_id,$exo_id, $score, $weighting)
{
	global $_configuration, $_user, $_cid;
	$TABLETRACK_EXERCICES = Database::get_statistic_table(TABLE_STATISTIC_TRACK_E_EXERCICES);
