...
function prepare_course_repository($courseRepository, $courseId)
{
	...
	mkdir(api_get_path(SYS_COURSE_PATH).$courseRepository . "/multimedia", $perm);
...
function update_Db_course($courseDbName)
{
	...
	if(!$_configuration['single_database'])
	{
		api_sql_query("CREATE DATABASE IF NOT EXISTS `" . $courseDbName . "` DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci", __FILE__, __LINE__);
	}
	...
	// Multimedia
	$TABLETOOLMULTIMEDIA 			= $courseDbName . "multimedia";
	$TABLETOOLMULTIMEDIASOURCES 		= $courseDbName . "multimedia_sources";
	$TABLETOOLMULTIMEDIAPOST		= $courseDbName . "multimedia_post";

    //Glosario
    $TABLETOOLGLOSARIO = $courseDbName . "glosario";

	//Dmail

	$TABLETOOLDMAIL	= $courseDbName . "dmail_main";
	$TABLETOOLDMAILCARPETAS	= $courseDbName . "dmail_carpetas";
	$TABLETOOLDMAILADJUNTOS = $courseDbName . "dmail_adjuntos";
	...
	// Exam
	$TABLEQUIZEXAM 					= $courseDbName . "quiz_exam";
	...
	// Social_config
	$tbl_social_config = $courseDbName . 'social_config';
	...
	*/
	$sql = "
		...
		PRIMARY KEY (id)
		) TYPE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci";
	...
	*/
	...
	-----------------------------------------------------------
	*/
	// Exam tool - Tests/exams
	$sql = "
		CREATE TABLE `".$TABLEQUIZEXAM . "` (
		id mediumint unsigned NOT NULL,
		intentos smallint(6) NOT NULL DEFAULT '1',
		minimo smallint(6) NOT NULL DEFAULT '10',						
		PRIMARY KEY (id)
		)"; 
	api_sql_query($sql, __FILE__, __LINE__);
	...
	*/
	$sql = "
		...
		category enum('authoring','interaction','admin','ninguna_categoria') NOT NULL default 'authoring',
		PRIMARY KEY (id)
		) TYPE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci";
	api_sql_query($sql, __FILE__, __LINE__);
	...
	*/
	...
	$sql = "CREATE TABLE `".$TABLETOOLMULTIMEDIA . "` (
	 ...
	 PRIMARY KEY (`id`)) DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci";
	api_sql_query($sql, __FILE__, __LINE__);

	$sql = "CREATE TABLE `".$TABLETOOLMULTIMEDIASOURCES . "` (
	 id int(11) NOT NULL AUTO_INCREMENT,
	...
	// youtube
	$html = '<object width="560" height="349"><param name="movie" value="http://www.youtube.com/v/##url?version=3&amp;hl=es_ES&amp;rel=0"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/##url?version=3&amp;hl=es_ES&amp;rel=0" type="application/x-shockwave-flash" width="560" height="349" allowscriptaccess="always" allowfullscreen="true"></embed></object>';
	$sql = "INSERT INTO `". $TABLETOOLMULTIMEDIASOURCES ."` (name,icon,code,tag,url) 
	values ('Youtube','img/youtube.jpg','" . addslashes($html). "','##url','http://www.youtube.com/watch?v=##url')";
	api_sql_query($sql, __FILE__, __LINE__);

	//vimeo
	$html= '<object width="400" height="225"><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=##url&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=ff0179&amp;fullscreen=1&amp;autoplay=0&amp;loop=0" /><embed src="http://vimeo.com/moogaloop.swf?clip_id=##url&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=ff0179&amp;fullscreen=1&amp;autoplay=0&amp;loop=0" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="400" height="225"></embed></object>';
	$sql = "INSERT INTO `". $TABLETOOLMULTIMEDIASOURCES ."` (name,icon,code,tag,url) 
	values ('Vimeo','img/vimeo.png','" . addslashes($html). "','##url','http://vimeo.com/##url')";
	api_sql_query($sql, __FILE__, __LINE__);

	//Dailymotion
	$html= '<object width="560" height="315"><param name="movie" value="http://www.dailymotion.com/swf/video/##url?width=560"></param><param name="allowFullScreen" value="true"></param><param name="allowScriptAccess" value="always"></param><param name="wmode" value="transparent"></param><embed type="application/x-shockwave-flash" src="http://www.dailymotion.com/swf/video/##url?width=560" width="560" height="315" wmode="transparent" allowfullscreen="true" allowscriptaccess="always"></embed></object>';
	$sql = "INSERT INTO `". $TABLETOOLMULTIMEDIASOURCES ."` (name,icon,code,tag,url) 
	values ('Dailymotion','img/dailymotion.jpg','" . addslashes($html). "','##url','http://www.dailymotion.com/video/##url')";
	api_sql_query($sql, __FILE__, __LINE__);

	//Ivoox
	$html= '<object id="player" width="240" height="133" type="application/x-shockwave-flash" data="http://www.ivoox.com/playerivoox_ee_##url_1.html"><param name="movie" value="http://www.ivoox.com/playerivoox_ee_##url_1.html"></param><param name="AllowScriptAccess" value="always"></param><param name="allowFullScreen" value="true"></param><param name="wmode" value="transparent"></param><embed src="http://www.ivoox.com/playerivoox_ee_##url_1.html" type="application/x-shockwave-flash" allowfullscreen="true" wmode="transparent" allowscriptaccess="always" width="240" height="133"></embed></object>';
	$sql = "INSERT INTO `". $TABLETOOLMULTIMEDIASOURCES ."` (name,icon,code,tag) 
	values ('Ivoox','img/ivoox.gif','" . addslashes($html). "','##url')";
	api_sql_query($sql, __FILE__, __LINE__);

    //MP3 player (niftyplayer)
    $html= '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="165" height="37" id="niftyPlayer1" align=""><param name=movie value="niftyplayer/niftyplayer.swf?file=##url&as=1"><param name=quality value=high><param name=bgcolor value=#FFFFFF><embed src="niftyplayer/niftyplayer.swf?file=##url&as=1" quality=high bgcolor=#FFFFFF width="165" height="37" name="niftyPlayer1" align="" type="application/x-shockwave-flash" swLiveConnect="true" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed></object>';
	$sql = "INSERT INTO `". $TABLETOOLMULTIMEDIASOURCES ."` (name,icon,code,tag) 
	values ('MP3','img/podcast_logo.jpg','" . addslashes($html). "','##url')";
	api_sql_query($sql, __FILE__, __LINE__);
	
    
	//Flowplayer
	$html= '<a href="##url" style="display:block;width:425px;height:300px;" id="player"></a><script language="JavaScript">flowplayer("player", "flowplayer-3.2.7.swf");</script>';
	$sql = "INSERT INTO `". $TABLETOOLMULTIMEDIASOURCES ."` (name,icon,code,tag) 
	values ('Flowplayer','img/podcast_logo.jpg','" . addslashes($html). "','##url')";
	api_sql_query($sql, __FILE__, __LINE__);

	//Para la tabla de comentarios para elementos multimedia.
	$sql = "CREATE TABLE `" . $TABLETOOLMULTIMEDIAPOST . "` (
	...
	-----------------------------------------------------------
	*/
    $sql = "CREATE TABLE `" . $TABLETOOLGLOSARIO . "` (
	id INTEGER  NOT NULL AUTO_INCREMENT,
	...
	*/
	$sql = "
		CREATE TABLE `" . $TABLETOOLDMAIL . "` (
			id_mail int(10) unsigned NOT NULL auto_increment,
			asunto varchar(250) collate utf8_spanish_ci NOT NULL,
			envia int(10) unsigned NOT NULL default '0',
			recibe int(10) unsigned NOT NULL default '0',
	...
	$sql = "
		CREATE TABLE `". $TABLETOOLDMAILCARPETAS ."` (
	...
	//incrementamos el id de las carpetas hasta el 5
	//Hasta que no averigue como iniciar una secuencia con valor 5


	for ($c=1;$c<=4;$c++)
	{
		$sql = "INSERT INTO `". $TABLETOOLDMAILCARPETAS ."` (nombre,propietario) values ('carpeta',1)";
		api_sql_query($sql, __FILE__, __LINE__);
	}
	$sql = "Delete from `". $TABLETOOLDMAILCARPETAS ."`";		
	api_sql_query($sql, __FILE__, __LINE__);


	$sql = "
	CREATE TABLE `" . $TABLETOOLDMAILADJUNTOS . "` (
	...
	*/
	$sql = "
	CREATE TABLE  `" . $tbl_social_config . "` (
	...
	notificaciones int(10) unsigned NOT NULL,
	...
	*/
	api_sql_query("CREATE TABLE `".$TABLEGROUPS . "` (
		...
		PRIMARY KEY (id)
		) DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci", __FILE__, __LINE__);
	...
	api_sql_query("CREATE TABLE `".$TABLEITEMPROPERTY . "` (
		...
		) TYPE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;", __FILE__, __LINE__);
	...
	*/
	api_sql_query("
		...
		PRIMARY KEY (id)) DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci", __FILE__, __LINE__);

	/*
	-----------------------------------------------------------
		Dropbox tool
		Se incrementa el campo description a 1000
	-----------------------------------------------------------
	*/
	api_sql_query("
	...
	*/
	...
	$sql = "CREATE TABLE IF NOT EXISTS `$TABLELPVIEW` (" .
		...
		"progress		int		unsigned	default 0 ) DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci"; //lp's progress for this user
	if(!api_sql_query($sql, __FILE__, __LINE__))
	{
		error_log($sql,0);
	}
	...
	$sql = "CREATE TABLE IF NOT EXISTS `$TABLELPITEM` (" .
		...
		"max_time_allowed char(13) NULL default '') DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci"; //data from imsmanifest <adlcp:maxtimeallowed>
	if(!api_sql_query($sql, __FILE__, __LINE__))
	{
		error_log($sql,0);
	}
...
*	@version 1.2
*/
function fill_Db_course($courseDbName, $courseRepository, $language,$default_document_array,$vlab=null)
{
...
//contenido multimedia y examenes
	...
	//documentos	
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_DOCUMENT . "','document/document.php','folder_document.png','".string2binary(api_get_setting('course_create_active_tools', 'documents')) . "','0','squaregrey.gif','NO','_self','authoring')", __FILE__, __LINE__);
    //ejercicios
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_QUIZ . "','exercice/exercice.php','quiz.png','".string2binary(api_get_setting('course_create_active_tools', 'quiz')) . "','0','squaregrey.gif','NO','_self','authoring')", __FILE__, __LINE__);
    //enlaces
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_LINK . "','link/link.php','links.png','".string2binary(api_get_setting('course_create_active_tools', 'links')) . "','0','squaregrey.gif','NO','_self','authoring')", __FILE__, __LINE__);
    //trabajos
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_STUDENTPUBLICATION . "','work/work.php','works.png','".string2binary(api_get_setting('course_create_active_tools', 'student_publications')) . "','0','squaregrey.gif','NO','_self','authoring')", __FILE__, __LINE__);
    //multimedia
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', 'Multimedia','multimedia/index.php','multimedia.png','1','0','squaregrey.gif','0','_self','authoring')");	
//dmail
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', 'Dmail','dmail/index.php?dir=recibidos','dmail.png','1','0','squaregrey.gif','0','_self','interaction')");
//glosario
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', 'Glosario','glosario/index.php?letra=a','glosario.png','1','0','squaregrey.gif','0','_self','interaction')");	
//exámenes
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_QUIZ_EXAM . "','exam/exercice.php','examen.png','1','0','squaregrey.gif','NO','_self','authoring')", __FILE__, __LINE__);
    
	//INTERACCION

    //buzon
	//Lo elimino definitvamente.
    ...
    //agenda
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_CALENDAR_EVENT . "','calendar/agenda.php','agenda.png','".string2binary(api_get_setting('course_create_active_tools', 'agenda')) . "','0','squaregrey.gif','NO','_self','interaction')", __FILE__, __LINE__);
	//foros
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_FORUM . "','forum/index.php','forum.png','".string2binary(api_get_setting('course_create_active_tools', 'forums')) . "','0','squaregrey.gif','NO','_self','interaction')", __FILE__, __LINE__);
    //chat
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_CHAT . "','fchat/index.php','chat.png','".string2binary(api_get_setting('course_create_active_tools', 'chat')) . "','0','squaregrey.gif','NO','_blank','interaction')", __FILE__, __LINE__);
	//anuncios	
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_ANNOUNCEMENT . "','announcements/announcements.php','valves.png','".string2binary(api_get_setting('course_create_active_tools', 'announcements')) . "','0','squaregrey.gif','NO','_self','interaction')", __FILE__, __LINE__);
	//encuestas
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_SURVEY."','survey/survey_list.php','survey.png','1','0','','NO','_self','interaction')");	
	//redes sociales
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', 'Redessociales','social/index.php','social.png','1','0','','NO','_self','interaction')");	
    ...
    api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_COURSE_DESCRIPTION . "','course_description/','info.gif','".string2binary(api_get_setting('course_create_active_tools', 'course_description')) . "','0','squaregrey.gif','NO','_self','ninguna_categoria')", __FILE__, __LINE__);
	//servicio tecnico
    api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_COURSE_SERVTECNICO . "','servicio_tecnico/contacto.php','servicio_tecnico.jpg','1','0','squaregrey.gif','NO','_self','ninguna_categoria')", __FILE__, __LINE__);
	
	//grupos y usuarios desabilitados por defecto
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_USER . "','user/user.php','members.png',0,'0','squaregrey.gif','NO','_self','interaction')", __FILE__, __LINE__);
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_GROUP . "','group/group.php','group.png',0,'0','squaregrey.gif','NO','_self','interaction')", __FILE__, __LINE__);
	...
	-----------------------------------------------------------
	*/
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', '" . TOOL_TRACKING . "','tracking/courseLog_FD.php','statistics.gif','$visible4AdminOfCourse','1','', 'NO','_self','admin')", __FILE__, __LINE__);
	...
	api_sql_query("INSERT INTO `".$tbl_course_homepage."` VALUES ('','".TOOL_COURSE_MAINTENANCE."','course_info/maintenance.php','backup.gif','$visible4AdminOfCourse','1','','NO','_self', 'admin')", __FILE__, __LINE__);
        ...
        if ($vlab==1)
	{
	api_sql_query("INSERT INTO `" . $tbl_course_homepage . "` VALUES ('', 'Vlab','vlab/index.php','vlab.png','1','0','squaregrey.gif','0','_self','interaction')");	
	}
	...
	*/
	...
	if(api_get_setting('example_material_course_creation')<>'false')
	{
		...
		*/
		...
		$intro_text='<table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td width="110" valign="middle" align="left"><img src="'.api_get_path(WEB_IMG_PATH).'mr_dokeos.png" alt="mr. Didakos 2.0" title="mr. Didakos 2.0" /></td><td valign="middle" align="left">'.lang2db(get_lang('IntroductionText')).'</td></tr></table>';
