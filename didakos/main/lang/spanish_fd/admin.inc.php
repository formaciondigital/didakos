...
$DokeosConfigSettings = "Parámetros de configuración de Didakos";
...
$SurveyEmailSenderNoReplyComment = "¿ Los correos electrónicos utilizados para enviar las encuestas, deben usar el  correo electrónico del profesor/tutor o una dirección especial de correo electrónico a la que el destinatario no responde (definida en los parámetros de configuración de la plataforma) ?";
...
$ListadoDeAlumnos = "Listado de alumnos";
$ListadoDeProfesores = "Listado de profesores";
$ListadoDeInspectores = "Listado de inspectores";
$AnnadirAlumnos = "Añadir alumnos";
$AnnadirProfesores = "Añadir profesores";
$ImportacionMasivaDeUsuarios = "Importación masiva de usuarios";
$Matricular = "Matricular";
$EliminarUsuariosDeCursos = "Eliminar usuarios de cursos";
$Desmatricular = "Desmatricular";
$DesmatricularAlumnos = "Desmatricular alumnos";
$CursoSeleccionado = "Curso seleccionado";
$VerAlumnos = "Ver alumnos";
$AsignarProfesoresACursos = "Asignar profesores a cursos";
$Asignar = "Asignar";
$FinalizarCursos = "Finalizar cursos";
$CerrarAcceso = "Cerrar acceso";
$ElAccesoAlCurso = "El acceso al curso";
$HaSidoFinalizadoParaTodosLosAlumnos = "ha sido finalizado para todos los alumnos";
$FinalizarAlumnos = "Finalizar Alumnos";
$CerrarCurso = "Cerrar Curso";
$ElCurso = "El curso";
$HaSidoCerrado = "ha sido cerrado";
$HaSidoAbierto = "ha sido abierto";
$Informes = "Informes";
$SeguimientoPorCurso = "Seguimiento por curso";
$VerSeguimiento = "Ver seguimiento";
$CartaDeBienvenida = "Carta de bienvenida";
$CartasDeBienvenida = "Cartas de bienvenida";
$Crear = "Crear";
$Editar = "Editar";
$Eliminar = "Eliminar";
$Alumnos = "Alumnos";
$Opciones = "Opciones";
$CrearCartaBienvenida = "Crear carta de bienvenida";
$CrearCartaBienvenidaTexto1 = "<p>Inserte el nombre que desea para la carta de bienvenida, utilice un nombre que le permite recordar claramente su contenido</p>";
$CrearCartaBienvenidaTexto2 = "Ya existe una carta con este nombre";
$CrearCartaBienvenidaTexto3 = "Seleccione otro nombre o edite esta carta";
$CrearCartaBienvenidaTexto4 = "Inserte el contenido de la carta";
$CrearCartaBienvenidaTexto5 = "La carta de bienvenida ha sido creada correctamente con el nombre";
$SeleccionarCartaBienvenida = "Seleccionar carta de bienvenida";
$SeleccionarCartaBienvenidaSeleccione = "Seleccione la carta";
$SeleccionarCartaBienvenidaEditar = "<p>Seleccione la carta que desea <b>editar</b> y pulse el botón</p>";
$SeleccionarCartaBienvenidaEliminar = "<p>Seleccione la carta que desea <b>eliminar</b> y pulse el botón</p>";
$SeleccionarCartaBienvenidaEnviarACurso = "<p>Seleccione la carta que desea <b>enviar a un curso</b> y pulse el botón</p>";
$SeleccionarCartaBienvenidaEnviarAAlumno = "<p>Seleccione la carta que desea <b>enviar a un alumno</b> y pulse el botón</p>";
$SeleccionarCartaBienvenidaEnviarAClase = "<p>Seleccione la carta que desea <b>enviar a una clase</b> y pulse el botón</p>";
$EliminarCartaBienvenida = "Eliminar carta de bienvenida";
$EliminarCartaBienvenidaTexto1 = "La carta de bienvenida ha sido eliminada correctamente";
$EditarCartaBienvenida = "Editar carta de bienvenida";
$EditarCartaBienvenidaTexto1 = "La carta de bienvenida ha sido modificada correctamente";
$EditarCartaBienvenidaTexto2 = "<p>En el editor de texto que aparece a continuaci&oacute;n puede generar la plantilla del e-mail de carta de bienvenida que posteriormente podr&aacute; enviar a los alumnos de cada curso. Puede utilizar ciertos valores que ser&aacute;n sustituidos en el momento del envio y que se corresponden a los siguientes textos:</p><ul><li> #alumno# (Mostrar&aacute; nombre y apellidos del alumno)</li><li> #curso# (Mostrar&aacute; el nombre del curso)</li><li>#usuario# (Muestra el nombre de usuario)</li><li>#clave# (Muestra el password de acceso)</li></ul>";
$EnviarCartasDeBienvenida = "Enviar cartas de bienvenida";
$EnviarCartasDeBienvenidaTexto1 = "Las cartas de bienvenida han sido enviadas correctamentea los alumnos que dispongan de e-mail";
$EnviarCartasDeBienvenidaIndividuales = "Enviar cartas de bienvenida individuales";
$EnviarCartasDeBienvenidaIndividualesTexto1 = "Inserte el NIF del alumno al que quiere enviar las cartas de bienvenida";
$EnviarCartasDeBienvenidaIndividualesTexto2 = "A continuación se muestran los datos del alumno seleccionado, en la tabla inferior puede ver los cursos en los que el alumno se encuentra matriculado. Haga click sobre el icono \"enviar\" para mandar la carta de bienvenida a este alumno";
$EnviarCartasDeBienvenidaIndividualesTexto3 = "El alumno no dispone de una direccion de email";
$EnviarCartasDeBienvenidaIndividualesTexto4 = "El NIF que ha insertado no existe en la plataforma";
$EnviarCartasDeBienvenidaIndividualesTexto5 = "Error al enviar a alumno y gestor";
$EnviarCartasDeBienvenidaIndividualesTexto6 = "Error al enviar al alummno";
$EnviarCartasDeBienvenidaIndividualesTexto7 = "Error al enviar al gestor";
$EnviarCartasDeBienvenidaIndividualesTexto8 = "Carta enviada correctamente";
$EnviarCartasDeBienvenidaIndividualesColumna1 = "Código del curso";
$EnviarCartasDeBienvenidaIndividualesColumna2 = "Nombre del curso";
$EnviarCartasDeBienvenidaIndividualesColumna3 = "Enviar carta";
$EnviarACurso = "Enviar a curso";
$EnviarAAlumno = "Enviar a alumno";
$InsertarUsuario = "Insertar Usuario";
$AccesoAbierto = "Acceso abierto con éxito";
$AccesoCerrado = "Acceso cerrado con éxito";
$config = "Configuración";
$design = "Diseño";
$design_add = "Añadir diseño";
$design_edit = "Editar diseño";
$design_delete = "Eliminar diseño";
$courses = "Cursos";
$getdiploma = "Obterner diploma";
$diplomastrack = "Seguimiento de descargas";
$redessociales = "Redes sociales";
$redessocialesconfig = "Configurar redes sociales";
$proxy = "Proxy";
$proxyuserpwd = "Usuario y clave del proxy";
$proxyauth = "Auth del proxy";
$proxy_desc = "Si la plataforma está por detrás de un proxy indique su dirección y puerto xxx.xxx.xxx:yyyy";
$proxyuserpwd_desc = "Indique el usuario y el password del proxy";
$proxyauth_desc = "Tipo de autentificación";
