...
*/
$langInvalidId = "Su acceso al centro de formación ha sido denegado. Se ha producido un error al iniciar la sesión.<br><br><ul><li>Compruebe que el nombre de usuario introducido es el correcto.</li><li>Confirme que su clave es la correcta (asegurese de que la está escribiendo en minúsculas o mayúsculas).</li><li>Si los dos pasos previos no funcionan póngase en contacto con nuestro administrador.</li></ul>";
