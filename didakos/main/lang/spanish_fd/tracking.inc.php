...
$Duration = "Duración";
$SeguimientoExamenes = "Seguimiento Exámenes";
$SeguimientoEjercicios = "Seguimiento Ejercicios";
$SeguimientoNotasGlobales = "Seguimiento Notas Globales";
$SeguimientoConexiones = "Seguimiento Conexiones";
$Exportar = "Exportar";
$ExportarIntentos = "Exportar Intentos";
$ExportarNotas = "Exportar Notas";
$InformeGlobal = "Informe Global";
$TiempoDePermanenciaEnElCurso = "Tiempo de permanencia en el curso";
$MensajesEnElForo = "Mensajes en el Foro";
$MensajesEnElBuzon = "Mensajes en el Buzón";
$MediaEnLosExamenes = "Media en los exámenes";
$ProgresoMedioDeSeguimientoEnCurso = "Progreso Medio de Seguimiento en Curso (%)";
$MediaEnLosEjercicios = "Media en los ejercicios";
$NotaMediaDeExamenesRealizados = "Nota Media de Exámenes realizados";
$NotaGlobal = "Nota Global";
$UltimoAccesoPlataforma = "Último acceso plataforma";
$UltimoAccesoCurso = "Último acceso curso";
$InformeExpandidoConexionesPlataforma = "Informe expandido de conexiones a la plataforma";
$FechaLogin = "Fecha de Login";
$FechaLogout = "Fecha de Logout";
?>
