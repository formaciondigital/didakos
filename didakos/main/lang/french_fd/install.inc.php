...
$langMainDB = "Base principale de Didakos 2.0";
...
$langDBSettingIntro = "Le script d\'installation créera les bases de données principales de Didakos 2.0. Veuillez prendre en compte que Didakos 2.0 devra créer plusieurs bases de données. Si vous êtes restreint à une seule base de données par votre hébergeur, Didakos 2.0 ne fonctionnera pas, à moins que vous ne choisissiez l\'option \"Une seule base de données\".";
...
$langSingleDb = "Utiliser une ou plusieurs bases de données pour Didakos 2.0";
...
$DokeosNeedFollowingOnServer = "Pour que Didakos 2.0 puisse fonctionner, le serveur doit être équipé de:";
$WarningExistingDokeosInstallationDetected = "Attention !Une installation de Didakos 2.0 existe déja sur votre système.";
...
$ServerRequirementsInfo = "Librairies et fonctionnalités que le serveur doit être en mesure de fournir pour utiliser Didakos 2.0 à son plein potentiel";
...
$RecommendedSettingsInfo = "Paramètres recommandés pour tourner Didakos 2.0. Ces paramètres sont attribués dans le fichier de configuration php.ini sur votre serveur.";
$Setting = "Paramètre";
$Actual = "Actuellement";
$DirectoryAndFilePermissions = "Permissions sur les répertoires et fichiers";
$DirectoryAndFilePermissionsInfo = "Certains répertoires et les fichiers qu\'ils contiennent doivent permettre l\'écriture par le serveur web pour que Didakos 2.0 puisse fonctionner (fichiers envoyés par les étudiants, pages d\'accueil du campus en HTML, ...). Ceci nécessite généralement une modification manuelle sur le serveur.";
...
$DokeosLicenseInfo = "Didakos 2.0 est un logiciel libre distribué sous la licence GNU General Public Licence (GPL).";
$IAccept = "J\'accepte";
$ConfigSettingsInfo = "Les valeurs suivantes seront écrites dans votre fichier de configuration";
$DokeosInstallation = "Installation de Didakos 2.0";
$InstallDokeos = "Installer Didakos 2.0";
...
$Version_ = "Version";
$UpdateFromDokeosVersion = "Mise-à-jour depuis Didakos 2.0";
$WelcomToTheDokeosInstaller = "Bienvenue dans l\'installateur de Didakos 2.0";
...
$YouHaveMoreThanXCourses = "Vous avez plus de %d cours sur votre campus Didakos 2.0 ! %d cours seulement ont été mis à jour. Pour mettre les autres à jour, %s cliquez ici %s";
$ToProtectYourSiteMakeXAndYReadOnly = "Pour protéger son endroit, configurez %s comme archive de seul lecture (CHMOD 444) et éliminez l'archive %s.";
$Error = "Erreur";
$Back = "Retour";
...
$NoWritePermissionPleaseReadInstallGuide = "Certains fichiers ou répertoires ne permettent pas l\'écriture. Afin d\'installer Didakos 2.0, vous devriez d\'abord changer leurs permissions (en utilisant CHMOD). Merci de lire le %s guide d\'installation %s";
...
$DBSettingUpgradeIntro = "Le script de mise-à-jour va récupérer et modifier les/la base(s) de données de Didakos 2.0. Pour cela, ce script utilisera les bases de données et paramètres définis ci-dessous. Didakos 2.0 fonctionnant sur une très large palette de systèmes, et certains de systèmes n\'ayant peut-être pas encore été testés, nous recommandons avec insistance de procéder à une copie de sauvegarde complète de votre/vos base(s) de données avant d\'aller plus loin!";
$ExtensionMBStringNotAvailable = "Extension MBString non disponible";
$ExtensionMySQLNotAvailable = "Extension MySQL non disponible";
$DokeosArtLicense = "Les images et galeries de média dans Didakos 2.0 utilisent des images provenant des galeries d\'icônes de Nuvola, Crystal Clear et Tango. D\'autres images et média comme les diagrammes et les animations Flash sont empruntées de Wikimedia et des cours d\'Ali Pakdel et de Denis Hoa avec leur consentement et publiés sous la licence BY-SA Creative Commons. Vous pouvez trouvez les détails sur cette licence sur <a href=\"http://creativecommons.org/licenses/by-sa/3.0/deed.fr\">le site de CC</a>, où un lien en bas de page vous permet également de consulter le texte intégral de la licence.";
$PleasGoBackToStep1 = "Veuillez retourner à l\'étape 1";
$OptionalParameters = "Paramètres optionnels ";
$gestor = "Gérant";
$langSmtpFromEmail = " E-mail de l'expéditeur";
$langSmtpFromName = "Nom de l'expéditeur";
$langSmtpHost = "Serveur SMTP";
$langSmtpUser = "Utilisateur SMTP";
$langSmtpPass = "Clé de l'utilisateur SMTP";
$ExisteBBDD = "Déjà un schéma existe avec ce préfixe dans la base de données";
$exePermision = "Les directoires suivants doivent avoir des permissions de lecture, d'écriture et exécution:";
$NoExecutionPermission = "Les sous-directoires de fchat n'ont pas les permissions nécessaires:";
$Executable = "Des permissions correctes";
$NotExecutable = "Des permissions incorrectes";
$langbrazilian_fd = "brésilien";
$langcatalan_fd = "catalan";
$langenglish_fd = "anglais";
$langfrench_fd = "français";
$langspanish_fd = "espagnol";
$wrongUrl = "L'url est incorrect, doit commencer par http: // ";
?>
