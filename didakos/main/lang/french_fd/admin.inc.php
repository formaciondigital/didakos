...
$ListadoDeAlumnos = "Liste des élèves";
$ListadoDeProfesores = "Liste des professeurs";
$ListadoDeInspectores = "Liste des inspecteurs";
$AnnadirAlumnos = "Ajouter élèves";
$AnnadirProfesores = "Ajouter professeurs";
$ImportacionMasivaDeUsuarios = "Importation massive d'utilisateurs";
$Matricular = "Inscrire";
$EliminarUsuariosDeCursos = "Éliminer utilisateurs de cours";
$Desmatricular = "Annuler inscription";
$DesmatricularAlumnos = "Annuler inscription élèves";
$VerAlumnos = "Voir élèves";
$CursoSeleccionado = "Cours sélectionné";
$AsignarProfesoresACursos = "Attribuer professeurs aux cours";
$Asignar = "Attribuer";
$FinalizarCursos = "Clôturer cours";
$CerrarAcceso = "Fermer accès";
$ElAccesoAlCurso = "L'accès au cours";
$HaSidoFinalizadoParaTodosLosAlumnos = "a été clôturé pour tous les élèves";
$FinalizarAlumnos = "Terminer Élèves";
$CerrarCurso = "Fermer cours";
$ElCurso = "Le cours";
$HaSidoCerrado = "a été fermé";
$HaSidoAbierto = "a été ouvert";
$Informes = "Études";
$SeguimientoPorCurso = "Suivi par cours";
$VerSeguimiento = "Voir suivi";
$CartaDeBienvenida = "Carte de bienvenue";
$CartasDeBienvenida = "Cartes de bienvenue";
$Crear = "Créer";
$Editar = "Éditer";
$Eliminar = "Éliminer";
$Alumnos = "Élèves";
$Opciones = "Options";
$CrearCartaBienvenida = "Créer carte de bienvenue";
$CrearCartaBienvenidaTexto1 = "<p>Insérez le nom que vous désirez pour la carte de bienvenue, utilisez un nom qui vous permette de vous rappeler clairement de son contenu</p>";
$CrearCartaBienvenidaTexto2 = "Il existe déjà une carte avec le même nom";
$CrearCartaBienvenidaTexto3 = "Sélectionnez un autre nom ou éditez cette carte";
$CrearCartaBienvenidaTexto4 = "Insérez le contenu de la carte";
$CrearCartaBienvenidaTexto5 = "La carte de bienvenue a été crée correctement avec le nom";
$SeleccionarCartaBienvenida = "Sélectionnez carte de bienvenue";
$SeleccionarCartaBienvenidaSeleccione = "Sélectionnez la carte";
$SeleccionarCartaBienvenidaEditar = "<p>Sélectionnez la carte que vous désirez <b>éditer</b> et cliquez sur le bouton</p>";
$SeleccionarCartaBienvenidaEliminar = "<p>Sélectionnez la carte que vous désirez <b>éliminer</b> et cliquez sur le bouton</p>";
$SeleccionarCartaBienvenidaEnviarACurso = "<p>Sélectionnez la carte que vous désirez <b>envoyer à un cours</b> et cliquez sur le bouton</p>";
$SeleccionarCartaBienvenidaEnviarAAlumno = "<p>Sélectionnez la carte que vous désirez <b>envoyer à un élève</b> et cliquez sur le bouton</p>";
$SeleccionarCartaBienvenidaEnviarAClase = "<p>Sélectionnez la carte que vous désirez <b>envoyer à une classe</b> et cliquez sur le bouton</p>";
$EliminarCartaBienvenida = "Éliminer carte de bienvenue";
$EliminarCartaBienvenidaTexto1 = "La carte de bienvenue a été éliminée correctement";
$EditarCartaBienvenida = "Éditer carte de bienvenue";
$EditarCartaBienvenidaTexto1 = "La carte de bienvenue a été modifiée correctement";
$EditarCartaBienvenidaTexto2 = "<p>Dans l'éditeur de texte que apparaît à continuation, vous pouvez éditer le modèle d'e-mail de bienvenue que vous pourrez à posteriori envoyer aux élèves de chaque cours. Vous pouvez utiliser diverses valeurs qui seront remplacées au moment de l'envoi et qui correspondent aux textes suivants :</p><ul><li> #élève# (Montrera ; prénom et nom de l'élève)</li><li> #cours# (Montrera ; le nom du cours)</li><li>#utilisateur# (Montre le nom de l'utilisateur)</li><li>#identifiant# (Montre le mot de passe d'accès)</li></ul>";
$EnviarCartasDeBienvenida = "Envoyer cartes de bienvenue";
$EnviarCartasDeBienvenidaTexto1 = "Les cartes de bienvenue ont été envoyées correctement aux élèves qui disposent d'e-mail";
$EnviarCartasDeBienvenidaIndividuales = "Envoyer cartes de bienvenue individuelles";
$EnviarCartasDeBienvenidaIndividualesTexto1 = "Écrivez le numéro de carte d'identité de l'élève auquel vous voulez envoyer les cartes de bienvenue";
$EnviarCartasDeBienvenidaIndividualesTexto2 = "À continuation, nous vous montrons les données de l'élève sélectionné. Dans le tableau inférieur, vous pouvez voir les cours dans lesquels l'élève est inscrit. Cliquez sur l'icône \"envoyer\" pour envoyer la carte de bienvenue à cet élève";
$EnviarCartasDeBienvenidaIndividualesTexto3 = "L'élève ne dispose pas d'adresse e-mail";
$EnviarCartasDeBienvenidaIndividualesTexto4 = "Le numéro de carte d'identité que vous avez écrit n'existe pas dans la plateforme";
$EnviarCartasDeBienvenidaIndividualesTexto5 = "Erreur dans l'envoi à élève et gestionnaire";
$EnviarCartasDeBienvenidaIndividualesTexto6 = "Erreur dans l'envoi à l'élève";
$EnviarCartasDeBienvenidaIndividualesTexto7 = "Erreur dans l'envoi au gestionnaire";
$EnviarCartasDeBienvenidaIndividualesTexto8 = "Carte envoyée correctement";
$EnviarCartasDeBienvenidaIndividualesColumna1 = "Code du cours";
$EnviarCartasDeBienvenidaIndividualesColumna2 = "Nom du cours";
$EnviarCartasDeBienvenidaIndividualesColumna3 = "Envoyer carte";
$EnviarACurso = "Envoyer au cours";
$EnviarAAlumno = "Envoyer à élève";
$InsertarUsuario = "Écrire utilisateur";
$design = "Design";
$design_add = "Ajouter design";
$design_edit = "Éditer design";
$design_delete = "Éliminer design";
$courses = "Cours";
$diplomas = "Diplômes";
$getdiploma = "Obtenir diplôme";
$diplomastrack = "Suivi des téléchargements";
$redessociales = "Réseaux sociaux";
$redessocialesconfig = "Configurer réseaux sociaux";
				
// Configuración				
$redessocialesconfig = "Configuration des réseaux sociaux";
$redessocialesdesc = "Pour permettre l'accès de la plateforme aux réseaux sociaux, vous devez indiquer ici les données d'accès des applications registrées à votre nom dans chacun des réseaux sociaux.";
...
$save = "Enregistrer";
$configok = "La configuration a été enregistrée avec succès";
				
// Nuevos !!!				
$proxy = "Proxy";
$proxyuserpwd = "Identifiant et mot de passe du proxy";
$proxyauth = "Auth du proxy";
$proxy_desc = "Si la plateforme est derrière un proxy, indiquez son adresse et port xxx.xxx.xxx:yyyy";
$proxyuserpwd_desc = "Indiquez l'identifiant et le mot de passe du proxy";
$proxyauth_desc = "Type d'authentification";
$AccesoAbierto = "Accès ouvert";
$AccesoCerrado = "Accès fermé";
?>
