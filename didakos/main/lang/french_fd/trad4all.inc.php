...
$Document = "Documents";
$Learnpath = "Cours et examens"; /*FD*/
$Link = "Liens";
$Announcement = "Annonces";
$Dropbox = "Échange de documents"; /*FD*/
$Quiz = "Exercices"; /*FD*/
$langChat = "Chat"; /*FD*/
...
$wiki = "Wiki";
$Complete = "Réalisé";/*"Fait";*/ /*"Complété";*/
...
/* ADEMAS SE DEBEN INCLUIR EN LA CARPETA DEL IDIOMA LOS SIGUIENTES ARCHIVOS 
   CREADOS POR FD */
...
$MensajesForo = "Messages Forum"; /* FD */
$MensajesBuzon = "Messages Email"; /*FD*/
$EvaluacionGlobal = "Évaluation Globale"; 
$EXAMENES = "EXAMENS";
$Nota = "Note";
$MoyenneExamenes = "Moyenne des examens";
$Time= "Track time"; /* ? */
$Sin_intentar= "En attente"; /*"Pas essayé";*/  /*FD*/
$Incompleto= "En cours"; /*"Incomplet";*/
$Completado= "Réalisé";/*"Fait";*/ /*"Completé";*/
$Aprobado= "Reçu";
$Suspenso= "Suspendu";
$Visionado= "Vu";
$EJERCICIOSCOMPLEMENTARIOS = "EXERCICES COMPLÉMENTAIRES";
$NotaUltimoIntento = "Note Dernier Essai";
$NumeroIntentos = "Nombre d'essais";
$AccessDetails = "Access details"; /*?*/ 
$DateAndTimeOfAccess = "Date and time of Access"; /*?*/
$Duration = "Duration"; /* ? */
$Ver_examen="See the exam"; /* ? */
$ServTecnico = "Service technique";
...
/*------------------------------------------------------------------------------*/
/*http://version08.formaciondigital.com/courses/TESTCURSO/ -> /user_portal.php -> main/course_home/course_home.php */
$Curso="Cours";
$ConectadoCurso   = "Êst connecté au cours"; 
$HaceUnosInstantes = "Il y a quelques instants"; 
$HaceMuchoTiempo = "À long";
$Hace = "Il ya";
$Hora = "heure";
$Minuto = "minute";
$Dia = "jour";
...
$ConectadoChat="Êst connecté au chat";
