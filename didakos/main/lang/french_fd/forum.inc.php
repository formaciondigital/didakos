...
$Topics = "Sujets";
$Posts = "Messages"; /*Articles FD*/
$LastPosts = "Dernier message"; /*FD*/
$Message = "Message";
...
$Replies = "Réponses";
$Views = "Vues";
$LastPost = "Dernier message"; /*FD*/
$Quoting = "Citation";/*FD*/
$NotifyMe="Avisez-moi"; /*FD*/
...
$Threaded = "Thématique";
$Nested = "Hiérarchique";
$FlatView = "Affichage en ligne";        /*FD*/  /*"Vue linéaire";*/
$ThreadedView = "Affichage par thème";           /*"Vue thématique";*/
$NestedView = "Affichage hiérarchique";          /*"Vue hiérarchique";*/
$Structure = "Structure";
