...
$Matricular = "Inscrire";
$DNIIncorrecto = "Le numéro d'identité est incorrect";
$UbicacionFicheroCSV = "Localisation du fichier CSV";
$TipoDeUsuario = "Type d'utilisateur";
$Alumno = "Élève";
$Teletutor = "Télétuteur";
$Inspector = "Inspecteur";
$ImportarUsuarioTexto1 = "L'importation des élèves doit être réalisée par le biais d'un fichier CSV (champs séparés par ;) qui doit suivre le schèma suivant";
$ImportarUsuarioTexto2 = "Il est important de toujours inclure l'en-tête et les champs considérés obligatoires (en gras). Dans le cas des champs non obligatoires, les laisser en blanc sera suffisant. Le processus donnera accès à chaque élève et lui attribuera et nom d'utilisateur et un mot de passe et l'inscrira dans les cours qui lui sont indiqués par le biais des codes des cours séparés par des tubes \"|\". Dans le cas des tuteurs et inspecteurs, il n'est pas nécessaire de spécifier le numéro d'identité. <br><br>Les clés d'accès de chaque utilisateur pourront être indiquées dans le fichier. Dans le cas où elles seraient en blanc, le processus d'importation les génèrera.<br><br>Ici, vous pouvez télécharger un  <a href=\"exemple.csv\" target=\"_blank\">fichier CSV d'exemple</a>";
?>
