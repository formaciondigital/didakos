...
$langInvalidId = "El seu accés al centre de formació ha estat denegat. S'ha produït un error en iniciar la sessió.<br><br><ul><li>Comprovi que el nom d'usuari introduït és el correcte.</li><li>Confirmi que la seva clau és la correcta (asseguris que la està escrivint en minúscules o majúscules).</li><li> Si els dos passos previs no funcionen posis en contacte amb el nostre administrador.</li></ul><a href=http://fomentconsorci2010.formaciondigital.com>Tornar.</a>";
