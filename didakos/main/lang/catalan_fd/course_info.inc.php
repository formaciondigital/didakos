...
$langByDel = "En esborrar el lloc web d\'aquest curs s\'esborraran permanentment tots els documents que conté. S\'esborrarŽn del registre tots els seus estudiants (no se\'ls esborrara d\'altres cursos).<p>Vols realment esborrar aquest curs?";
$langY = "SI";
$langN = "NO";
...
$QuizEmailAlert = "Avisar mitjançant un correu electrònic quan s'enviï un nou exercici";
$QuizEmailAlertActivate = "Activar l'avís per correu electrònic de que s'han enviat les respostes d'un exercici";
$QuizEmailAlertDeactivate = "Desactivar l'avís per correu electrònic de que s'han enviat les respostes d'un exercici";
$AllowUserImageForum = "Imatge dels usuaris en el fòrum";
$AllowUserImageForumActivate = "Mostra les imatges dels usuaris en el fòrum";
$AllowUserImageForumDeactivate = "Oculta les imatges dels usuaris en el fòrum";
$AllowLearningPathTheme = "Permetre temes en Itineraris d'aprenentatge";
$AllowLearningPathThemeAllow = "Permés";
$AllowLearningPathThemeDisallow = "No permés";
// Revisión idiomas Didakos 2.0 03/02/2012
$SoloAdministradores = "Eina solament accessible per a administradors";
?>
