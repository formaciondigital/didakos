...
$QuizEmailAlert = "Notificar por e-mail ao enviar um novo exercício";
$QuizEmailAlertActivate = "Habilitar notificações de respostas por email foram enviados de um ano";
$QuizEmailAlertDeactivate = "Desativar a notificação de respostas por email foram enviados de um ano";
$AllowUserImageForum = "Imagem dos usuários do fórum";
$AllowUserImageForumActivate = "Exibe imagens no fórum";
$AllowUserImageForumDeactivate = "Imagens ocultas em usuários de fórum";
$AllowLearningPathTheme = "Permitir temas na Aprendizagem caminho";
$AllowLearningPathThemeAllow = "Permitido";
$AllowLearningPathThemeDisallow = "Não permitido";
// Revisión idiomas Didakos 2.0 03/02/2012
$SoloAdministradores = "Ferramentas somente para administradores";
?>
