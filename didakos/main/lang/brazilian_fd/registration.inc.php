...
$DNIIncorrecto = "O DNI é incorreto";
$UbicacionFicheroCSV = "Localização de arquivo CSV";
$TipoDeUsuario = "Tipo de usuário";
$Alumno = "Aluno";
$Teletutor = "Tutor";
$Inspector = "Inspetor";
$ImportarUsuarioTexto1 = "A importação do aluno deve ser realizada através de um arquivo CSV (campos separados por;) que deve seguir o seguinte formato";
$ImportarUsuarioTexto2 = "É importante incluir sempre o cabeçalho e os campos considerados como obrigatórios (em negrito), no caso de não disponibilizar algum campo não obrigatório é suficiente deixar o campo em branco. O processo irá registrar cada aluno atribuindo nome de usuário, senha e matriculando em cursos que vão indicar através dos códigos de curso separados por tubos \"|\".No caso de tutores e inspetores não é necessário especificar o D.N.I<br><br>. As senhas de acesso de qualquer usuário podem ser indicadas no arquivo, caso deixarem em branco o processo de importação irá gerar <br><br>Aqui você pode baixar um  <a href=\"exemple.csv\" target=\"_blank\">archivo CSV de ejemplo</a>";
?>
