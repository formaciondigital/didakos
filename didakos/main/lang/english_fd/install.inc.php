...
$langWarningResponsible  = "Use this script only after backup. Didakos 2.0 team is not responsible if you lost or corrupted data";
...
$langMainDB = "Main Didakos 2.0 database (DB)";
...
$langDBSettingIntro = "The install script will create the Didakos 2.0 main database(s). Please note that Didakos 2.0 will need to create several databases. If you are allowed to use only one database by your Hosting Service, Didakos 2.0 will not work, unless you chose the option \"One database\".";
...
$langSingleDb = "Use one or several DB for Didakos 2.0";
...
$langDokeosURL = "URL of Didakos 2.0";
$langUserDB = "User DB";
$langInstallationLanguage = "Installation Language";
$ReadThoroughly = "Read thoroughly";
$DokeosNeedFollowingOnServer = "For Didakos 2.0 to work, you need the following on your server";
$WarningExistingDokeosInstallationDetected = "Warning!<br />The installer has detected an existing Didakos 2.0 platform on your system.";
...
$ServerRequirementsInfo = "Libraries and features the server must provide to use Didakos 2.0 to its full extent";
...
$DirectoryAndFilePermissionsInfo = "Some directories and the files they include must be writeable by the web server in order for Didakos 2.0 to run (students uploaded files, homepage html files, ...). This might imply a manual change on your server (outside of this interface).";
$NotWritable = "Not writable";
$Writable = "Writable";
$ExtensionLDAPNotAvailable = "LDAP Extension not available";
$ExtensionGDNotAvailable = "GD Extension not available";
$DokeosLicenseInfo = "Didakos 2.0 is free software distributed under the GNU General Public licence (GPL).";
$IAccept = "I Accept";
$ConfigSettingsInfo = "The following values will be written into your configuration file";
$DokeosInstallation = "Didakos 2.0 Installation";
$InstallDokeos = "Install Didakos 2.0";
...
$Version_ = "Version";
$UpdateFromDokeosVersion = "Update from Didakos 2.0";
$WelcomToTheDokeosInstaller = "Welcome to the Didakos 2.0 Installer";
...
$YouHaveMoreThanXCourses = "You have more than %d courses on your Didakos 2.0 platform ! Only %d courses have been updated. To update the other courses, %sclick here %s";
$ToProtectYourSiteMakeXAndYReadOnly = "To protect your site, make %s read-only (CHMOD 444),and delete the following file: %s";
$Error = "Error";
$Back = "Back";
...
$NoWritePermissionPleaseReadInstallGuide = "Some files or folders don\'t have writing permission. To be able to install Didakos 2.0 you should first change their permissions (using CHMOD). Please read the %s installation guide %s";
...
$DBSettingUpgradeIntro = "The upgrade script will recover and update the Didakos 2.0 database(s). In order to do this, this script will use the databases and settings defined below. Because our software runs on a wide range of systems and because all of them might not have been tested, we strongly recommend you do a full backup of your databases before you proceed with the upgrade!";
$ExtensionMBStringNotAvailable = "MBString extension not available";
$ExtensionMySQLNotAvailable = "MySQL extension not available";
$DokeosArtLicense = "The images and media galleries of Didakos 2.0 use images from Nuvola, Crystal Clear and Tango icon galleries. Other images and media like diagrams and Flash animations are borrowed from Wikimedia and Ali Pakdel\'s and Denis Hoa\'s courses with their agreement and released under BY-SA Creative Commons license. You may find the license details at <a href=\"http://creativecommons.org/licenses/by-sa/3.0/\">the CC website</a>, where a link to the full text of the license is provided at the bottom of the page.";
$PleasGoBackToStep1 = "Please go back to step 1";
$OptionalParameters = "Optional parameters";
$gestor = "administrator"; 
$langSmtpFromEmail = "Sender email"; 
$langSmtpFromName = "Sender name"; 
$langSmtpHost = " SMTP server";
$langSmtpUser = "SMTP user"; 
$langSmtpPass = " SMTP user name";
$ExisteBBDD = "There is already a scheme with that database prefix"; 
$exePermision = "LThe following directories should be readable, writable and executable: ";
$NoExecutionPermission = "chat subfolders haven't required permissions: ";
$Executable = "wright permissions";
$NotExecutable = "wrong permissions";
$langbrazilian_fd = "Brazilian"; 
$langcatalan_fd = "Catalan"; 
$langenglish_fd = "English";  
$langfrench_fd = "French";  
$langspanish_fd = "Spanish"; 
$wrongUrl = "wrong url,must begin with http:// ";
?>
