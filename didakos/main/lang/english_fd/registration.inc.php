...
$Matricular = "Enroll";
$DNIIncorrecto = "Identification not valid";
$UbicacionFicheroCSV = "Location of the CSV file";
$TipoDeUsuario = "Type of user";
$Alumno = "Student";
$Teletutor = "Teletutor";
$Inspector = "Inspector";
$ImportarUsuarioTexto1 = "The importation of students should be realized through a CSV file (camps separated by ;) that should follow the following format";
$ImportarUsuarioTexto2 = "It's important to always include the header and the camps considered to be obligatory (in bold), in the case of not disposing of an obligatory camp, it's enough to leave the camp empty. The process will enroll each student, assigning them a username and key and enrolling them on the specific courses that are indicated to them through the course codes separated by lines \"|\". In the case of tutors and inspectors it is not necessary to specify the D.N.I<br><br> The access keys of any user can be indicated in the file, in the case that they are left empty, the importation process generates them<br><br> Here you can download <a href=\"example.csv\" target=\"_blank\">file CSV de example</a>";
?>
