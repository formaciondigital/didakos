...
$SeguimientoExamenes = "Exam Progress Report";
$SeguimientoEjercicios = "Exercise Progress Report ";
$SeguimientoNotasGlobales = "Overall grade Progress Report ";
$SeguimientoConexiones = "Connections Progress Report";
$Exportar = "Export";
$ExportarIntentos = "Export Tries";
$ExportarNotas = "Export Grades";
$InformeGlobal = "Overall report";
$TiempoDePermanenciaEnElCurso = "Time in course";
$MensajesEnElForo = "Messages in forum";
$MensajesEnElBuzon = "Messages in inbox";
$MediaEnLosExamenes = "Average in the exams";
$ProgresoMedioDeSeguimientoEnCurso = "Average progress of the Course Progress Report (%)";
$MediaEnLosEjercicios = "Average in the exercises";
$NotaMediaDeExamenesRealizados = "Average grade in the exams done";
$NotaGlobal = "Overall grade";
$UltimoAccesoPlataforma = "Last access to the platform";
$UltimoAccesoCurso = "Last acces to the course";
$InformeExpandidoConexionesPlataforma = "Report expanded to connections to the platform";
$FechaLogin = "Login Date";
$FechaLogout = "Logout Date";
?>
