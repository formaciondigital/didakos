...
$DokeosConfigSettings = "Didakos configuration settings";
...
$ListadoDeAlumnos = "List of students";
$ListadoDeProfesores = "List of teachers";
$ListadoDeInspectores = "List of inspectors";
$AnnadirAlumnos = "Add students";
$AnnadirProfesores = "Add teachers";
$ImportacionMasivaDeUsuarios = "Mass import of users";
$Matricular = "Enroll";
$EliminarUsuariosDeCursos = "Delete users from course";
$Desmatricular = "Unenroll";
$DesmatricularAlumnos = "Unenroll students";
$VerAlumnos = "See students";
$CursoSeleccionado = "Course selected";
$AsignarProfesoresACursos = "Assign teachers to courses";
$Asignar = "Assign";
$FinalizarCursos = "Close courses";
$CerrarAcceso = "Close access";
$ElAccesoAlCurso = "Access to course";
$HaSidoFinalizadoParaTodosLosAlumnos = "Has been closed to all students";
$FinalizarAlumnos = "Close access to students";
$CerrarCurso = "Close course";
$ElCurso = "The course";
$HaSidoCerrado = "Has been closed";
$HaSidoAbierto = "Has been opened";
$Informes = "Reports";
$SeguimientoPorCurso = "Progress Report by course";
$VerSeguimiento = "See Progress Report";
$CartaDeBienvenida = "Welcome letter";
$CartasDeBienvenida = "Welcome letters";
$Crear = "Create";
$Editar = "Edit";
$Eliminar = "Delete";
$Alumnos = "Students";
$Opciones = "Options";
$CrearCartaBienvenida = "Create welcome letter";
$CrearCartaBienvenidaTexto1 = "<p>Insert name into the welcome letter, using a name that allows you to clearly remember its content</p>";
$CrearCartaBienvenidaTexto2 = "There is already a letter with this name";
$CrearCartaBienvenidaTexto3 = "Select another name or edit this letter";
$CrearCartaBienvenidaTexto4 = "Insert content into letter";
$CrearCartaBienvenidaTexto5 = "The welcome letter has been created correctly with the name";
$SeleccionarCartaBienvenida = "Select welcome letter";
$SeleccionarCartaBienvenidaSeleccione = "Select letter";
$SeleccionarCartaBienvenidaEditar = "<p>Select letter <b>edit</b> and press button</p>";
$SeleccionarCartaBienvenidaEliminar = "<p>Select letter  <b>delete</b> and press button</p>";
$SeleccionarCartaBienvenidaEnviarACurso = "<p>Select letter  <b>send to a course</b> and press button</p>";
$SeleccionarCartaBienvenidaEnviarAAlumno = "<p>Select letter <b>send to a student</b> and press button </p>";
$SeleccionarCartaBienvenidaEnviarAClase = "<p>Select letter <b>send to a class</b> and press button</p>";
$EliminarCartaBienvenida = "Delete welcome letter";
$EliminarCartaBienvenidaTexto1 = "The welcome letter has been deleted correctly";
$EditarCartaBienvenida = "Edit welcome letter";
$EditarCartaBienvenidaTexto1 = "The  welcome letter has been modified correctly";
$EditarCartaBienvenidaTexto2 = "<p>In the text editor that will appear now the template of the welcome letter email can be generated that can then be sent to the students of each course. You can use certain values that will be substituted when the letter is sent and that correspond to the following texts:</p><ul><li> #student# (Show&aacute; name and surname of the student)</li><li> #course# (Show&aacute; the name of the course)</li><li>#user# (Show the name of the user)</li><li>#key# (Show the access password)</li></ul>";
$EnviarCartasDeBienvenida = "Send welcome letters";
$EnviarCartasDeBienvenidaTexto1 = "The welcome letters have been sent correctly to those students who have an email";
$EnviarCartasDeBienvenidaIndividuales = "Send individual welcome letters";
$EnviarCartasDeBienvenidaIndividualesTexto1 = "Insert the NIF of the student to which you want to send the welcome letter";
$EnviarCartasDeBienvenidaIndividualesTexto2 = "The following are the details of the selected student, in the table below you can see the courses in which the student is enrolled. Click on the icon  \"send\" to send the welcome letter to this student";
$EnviarCartasDeBienvenidaIndividualesTexto3 = "The student does not have a correct email address";
$EnviarCartasDeBienvenidaIndividualesTexto4 = "The NIF inserted does not exist on the platform";
$EnviarCartasDeBienvenidaIndividualesTexto5 = "Error when sent to the student and administrator";
$EnviarCartasDeBienvenidaIndividualesTexto6 = "Error when sent to the student";
$EnviarCartasDeBienvenidaIndividualesTexto7 = "Error when sent to the administrator";
$EnviarCartasDeBienvenidaIndividualesTexto8 = "Letter sent correctly";
$EnviarCartasDeBienvenidaIndividualesColumna1 = "Course code";
$EnviarCartasDeBienvenidaIndividualesColumna2 = "Course name";
$EnviarCartasDeBienvenidaIndividualesColumna3 = "Send letter";
$EnviarACurso = "Send to course";
$EnviarAAlumno = "Send to student";
...
$proxyauth = "Auth of proxy";
$proxy_desc = "If the plataform is behind a proxy indicate its address and port xxx.xxx.xxx:yyyy";
$proxyuserpwd_desc = "Indicate the proxy username and password";
$proxyauth_desc = "Type de authentication";
$AccesoAbierto = "Successfully opened access";
$AccesoCerrado = "Successfully closed access";
?>
