...
echo  ' | <a href="courseLogg_ins_examenes.php?'.api_get_cidreq().'&studentlist=true">'.get_lang('SeguimientoExamenes').'</a>&nbsp; 
	| '.get_lang('SeguimientoEjercicios').'
...
echo '<div class="clear"></div>';
	...
	if(count($a_students)>0)
	{
		...
		// Rellenamos una fila más resumen con las medias de los ejercicios, sacamos los ejercicios por el mismo orden que al montarla cabecera de 
