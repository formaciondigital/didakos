...
$teachers = array();
//fd - cambio . eliminamos la opcion por defecto (--sin responsable-- , id=0) en la lista de formadores para que no introduzca una matriculacion con el user_id=0
...
//## vlab egarcia 26/04/10
$form->addElement('radio', 'vlab', 'Laboratorio virtual', get_lang('Allowed'), 1);
$form->addElement('radio', 'vlab', null, get_lang('NotAllowedToUnsubscribe'), 0);
//## vlab
...
if( $form->validate())
{
	...
	if (sizeof($keys))
	{
		...
		//## vlab egarcia 26/04/10
		fill_Db_course($currentCourseDbName, $currentCourseRepository, $course_language,$pictures_array,$course['vlab']);
		//##
		...
		//## 10/01/2012 - cambiofd - vlab - eliminada la creacionde la plataforma en el esquema vlab
