        ...
        if ( !$error)
        {
            ...
            else
            {
	        	...
	        	if ( !$error)
	        	{
					...
					//CAMBIO FD - añadimos el campo asunto en la creacion del nuevo correo
		            new Dropbox_SentWork( $_user['user_id'], $dropbox_title, $_POST['description'], strip_tags($_POST['authors']), $dropbox_filename, $dropbox_filesize, $newWorkRecipients,$_POST['asunto']);
	        	}
            }
        }
    } //end if(!$error)
