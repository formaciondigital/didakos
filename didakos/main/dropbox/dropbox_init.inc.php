...
$javascript = "<script>
	...
	{
	   	num_caracteres = document.form.description.value.length;
	   	if (num_caracteres > num_caracteres_permitidos)
		{
	      		document.form.description.value = contenido_textarea;
	   	}
		else
		{
		      contenido_textarea = document.form.description.value;
	   	}

	   	if (num_caracteres >= num_caracteres_permitidos)
		{
		      document.form.caracteres.style.color=\"#ff0000\";
	   	}
		else
		{
		      document.form.caracteres.style.color=\"#000000\";
	   	}
   		cuenta()
	}
	...
	function cuenta()
	{
	   document.form.caracteres.value=document.form.description.value.length;
	} 
	";
