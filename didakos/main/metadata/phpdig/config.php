...
$phpdig_string_subst['iso-8859-2'] = 'A:ÁÂÄÃ¡,C:ÇÆÈ,D:ÏÐ,E:ÉËÊÌ,I:ÍÎ,L:Å¥£,N:ÑÒ,O:ÓÔÖÕ,R:ÀØ,S:Šª©,T:Þ«,U:ÚÜÙÛ,Y:Ý,Z:¬¯®,a:áâäã±,c:çæè,d:ïð,e:éëêì,i:íî,l:åµ³,n:ñò,o:óôöõ,r:àø,s:¶º¹,t:þ»,u:úüùû,y:ý,z:Œ¿Ÿ';
$phpdig_string_subst['iso-8859-6'] = 'Q:Q,q:q';
//$phpdig_string_subst['iso-8859-7'] = 'é:ßú,á:Ü,å:Ý,ç:Þ,ï:ü,õ:ýû,ù:þ';
$phpdig_string_subst['iso-8859-7'] = 'á:Á¶Ü,â:Â,ã:Ã,ä:Ä,å:ÅžÝ,æ:Æ,ç:ÞÇ¹,è:è,é:ßúÉº,ê:Ê,ë:Ë,ì:Ì,í:Í,î:Î,ï:üŒÏ,ð:Ð,ñ:Ñ,ó:Óò,ô:Ô,õ:ýûÕŸ,ö:Ö,÷:×,ø:Ø,ù:þÙ¿';
...
$phpdig_words_chars['iso-8859-7'] = '[:alnum:]ÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÓÔÕÖ×ØÙ¢ž¹ºŒŸ¿ÚÛáâãäåæçèéêëìíîïðñóôõö÷øùÜÝÞßüýþúûÀà';
$phpdig_words_chars['tis-620'] = '[:alnum:]¡¢£€¥Š§š©ª«¬_®¯°±²³Žµ¶·ž¹º»ŒœŸ¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÜßàáâãäåæçèéêëìíîïðñòóôõö÷øùúû';
