...
Recursos Extras
*/
define('RESOURCE_GLOSARIO', 'glosario');
define('RESOURCE_MULTIMEDIA', 'multimedia');
...
class Resource
{
	...
	function get_tool()
	{
		switch($this->get_type())
		{
			...
			case RESOURCE_GLOSARIO:
				return TOOL_GLOSARIO;
			case RESOURCE_MULTIMEDIA:
				return TOOL_MULTIMEDIA;
			default:
				return null;
		}
	}
