...
if($encryptPassForm)
{
	$passToStore=md5($passForm);
        $gestorpassToStore = md5($gestorpassForm);
}
else
{
	$passToStore=($passForm);
        $gestorpassToStore = ($gestorpassForm);
}
...
//no creamos las bases de datos aqui sino en el propio .sql
/*
if(!$singleDbForm)
{
...
*/
include("../lang/spanish_fd/create_course.inc.php");

if($languageForm != 'spanish_fd')
{
...
$installation_settings['{PLATFORM_URL}'] = $urlForm;

$installation_settings['{MYSQL_PREFIX}'] = $dbPrefixForm;

$installation_settings['{GESTORLASTNAME}'] = $gestorLastName;
$installation_settings['{GESTORFIRSTNAME}'] = $gestorFirstName;
$installation_settings['{GESTORLOGIN}'] = $gestorloginForm;
$installation_settings['{GESTORPASSWORD}'] = $gestorpassToStore;
$installation_settings['{GESTOREMAIL}'] = $gestoremailForm;
