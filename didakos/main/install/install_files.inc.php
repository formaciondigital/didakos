...
if(defined('DOKEOS_INSTALL'))
{
	...
	write_dokeos_config_file('../inc/conf/configuration.dist.php');
        ...
        //write mail configuracion file
        write_dokeos_mail_config_file('../inc/conf/mail.conf.dist.php');
        //write mail configuracion backup file
        write_dokeos_mail_config_file('../inc/conf/mail.conf.php');
	...
	copy('../inc/conf/profile.conf.dist.php','../inc/conf/profile.conf.php');
        //copy('index.htm.dist','../../index.html');
}
else
{
