...
Autor: Jesús Zafra
Página incial: index.php (1.8.5)
Página actual: index.php
Descripción: 
--Eliminamos la caja de login lateral. buscar ##cambio para encontrarlo
--Se modifica el enlace de logout para que redirija a inicial.asp
...
//##cambio - si el login falla redirigimos a la pagina inicial
$loginFailed = isset($_GET['loginFailed']) ? true : isset($loginFailed);
		if ($loginFailed)
		{
			$error_login = handle_login_failed();
		}

//##cambio
	header("Location:main/gestor/statistics_new/index.php");
	exit();		
...
function handle_login_failed()
{
	...
	//##cambio
     return "<div id=\"login_fail\" width=\"100%\" align=\"left\" >".$message."</div>";
}
